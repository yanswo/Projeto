...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SEU SALDO ATUAL É DE:");

        textoSaldo.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Menus/images/perfil.png"))); // NOI18N
    ...
    private void menu_saqueMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menu_saqueMouseClicked
      Saque saque = new Saque(usuarioLogado, this);
    ...
    private void menu_transferenciaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menu_transferenciaMouseClicked
      Transferencia transferencia = new Transferencia(usuarioLogado, this);
